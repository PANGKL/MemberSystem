    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PARENT', 'Parent'), ('COACH', 'Coach'), ('ADMIN', 'Admin')], default='PARENT', max_length=10)),
                ('points', models.IntegerField(default=0)),
                ('level', models.CharField(choices=[('NOVICE', 'Novice'), ('EXPERT', 'Expert')], default='NOVICE', max_length=10)),
