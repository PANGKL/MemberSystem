...
class Activity(models.Model):
    ...
    location = models.CharField(max_length=255, blank=True, null=True) # 新增地點
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00) # 新增價格
...
class Registration(models.Model):
    ...
    medical_statement = models.TextField(blank=True, null=True) # 檔案路徑或內容
